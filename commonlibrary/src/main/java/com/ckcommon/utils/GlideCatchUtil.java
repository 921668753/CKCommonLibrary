...
import com.antiwearvalve.atwwg.constant.StringConstants;
...
public class GlideCatchUtil {
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(MyApplication.getInstance().getCacheDir() + "/" + StringConstants.PHOTOPATH)));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    public boolean cleanCatchDisk() {
        return deleteFolderFile(MyApplication.getInstance().getCacheDir() + "/" + StringConstants.PHOTOPATH, true);
    }
